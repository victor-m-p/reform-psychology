...
then
	...
	Rscript --vanilla main_model.R \
		...
		"/work/50114/MAG/modeling/replication_fos/models/main_model/"

	# run prior_sensitivity.R
	echo "-- running prior_sensitivity.R (replication_fos) --"
	Rscript --vanilla prior_sensitivity.R \
		"psychology_replication_matched.csv" \
		"/work/50114/MAG/modeling/replication_fos/models/prior_sensitivity/m_post_" \
	...
	Rscript --vanilla likelihood_comparison.R \
		"psychology_replication_matched.csv" \
		"/work/50114/MAG/modeling/replication_fos/models/likelihood_comparison/" \
...
then
	...
	Rscript --vanilla main_model.R \
		...
		"/work/50114/MAG/modeling/reproducibility_fos/models/main_model/"

	# run prior_sensitivity.R
	echo "-- running prior_sensitivity.R (reproducibility_fos) --"
	Rscript --vanilla prior_sensitivity.R \
		"psychology_reproducibility_matched.csv" \
		"/work/50114/MAG/modeling/reproducibility_fos/models/prior_sensitivity/m_post_" \
	...
	Rscript --vanilla likelihood_comparison.R \
		"psychology_reproducibility_matched.csv" \
		"/work/50114/MAG/modeling/reproducibility_fos/models/likelihood_comparison/" \
...
then
	...
	Rscript --vanilla main_model.R \
		...
		"/work/50114/MAG/modeling/replicat_fos/models/main_model/"

	# run prior_sensitivity.R
	echo "-- running prior_sensitivity.R (replication_keyword) --"
	Rscript --vanilla prior_sensitivity.R \
		"psychology_replicat_matched.csv" \
		"/work/50114/MAG/modeling/replicat_fos/models/prior_sensitivity/m_post_" \
	...
	Rscript --vanilla likelihood_comparison.R \
		"psychology_replicat_matched.csv" \
		"/work/50114/MAG/modeling/replicat_fos/models/likelihood_comparison/" \
