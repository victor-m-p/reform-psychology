...
# set outpath 
outpath = '/work/50114/MAG/modeling/replication_keyword/models/prior_sensitivity/m_post_' 
...
clrs = color_scheme_get("orange")
theme_set(theme_classic())
outpath = "/work/50114/MAG/fig/modeling/replication_keyword/prior_sensitivity/"
width = 8
height = 4
...
light_color = clrs[3]$mid
dark_color = clrs[6]$dark_highlight
...
int_data <- tibble(priSD, int_ci_lower, int_ci_upper, int_ci_est) %>% 
  mutate(condition = case_when(priSD == 0.5 ~ 'our_prior', TRUE ~ 'other_prior')) %>%
  glimpse()
```
