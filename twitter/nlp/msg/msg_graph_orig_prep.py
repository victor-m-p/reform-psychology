...
G = nx.read_gml("/work/cn-some/data_msg/diplomat_orig_G.gml", destringizer=int) # takes some time to load
...
get_new_G(data, G, "W_max", "diplomat_orig_wmax")
get_new_G(data, G, "graph_community", "diplomat_orig_community")
